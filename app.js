const $=id=>document.getElementById(id);let catalog=null,current=null,rows={};
const defs=[
{id:'execPlan',stage:'啟動',name:'執行服務計畫書',base:'sign',days:30,pcm:true,basis:'簽約後30日內提送'},
{id:'surveyPlan',stage:'調查',name:'補充測量工作計畫書',base:'sign',days:30,pcm:true,basis:'簽約後30日內提送'},
{id:'geoPlan',stage:'調查',name:'補充地質調查工作計畫書',base:'sign',days:30,pcm:true,basis:'簽約後30日內提送'},
{id:'utilityPlan',stage:'調查',name:'管線調查工作計畫書',base:'sign',days:30,pcm:true,basis:'簽約後30日內提送'},
{id:'surveyResult',stage:'調查',name:'補充測量成果報告',base:'surveyPlanApproval',days:120,pcm:true,basis:'工作計畫核定後120日內'},
{id:'geoResult',stage:'調查',name:'補充地質調查成果報告',base:'geoPlanApproval',days:120,pcm:true,basis:'工作計畫核定後120日內'},
