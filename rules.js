window.YilanRules = {
  commonRules: [
    ...
    {id:'designRiskPlan',group:'配套成果',name:'施工風險評估執行服務計畫書',triggerType:'signDate',days:60,dayType:'calendar',predecessor:'sign',contractRule:true,deadlineClass:'contract',conditional:false,note:'契約生效後60日內提送'},
